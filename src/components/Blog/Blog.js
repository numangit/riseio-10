...
const Blog = () => {
    return (
        <div className="my-lg-0 pb-sm-5 py-5 mt-5 mb-0 mt-md-0">
            <div>
                <h2 className="my-2 my-lg-4 fw-bold display-5 text-light">Frequently Asked Questions</h2>
                <p className='px-lg-0 px-3 fs-5 mb-1 mb-lg-5 text-light'>Below are some frequently asked questions by our visiters :</p>
                <Accordion className="my-3 py-5 py-md-0 col-11 col-md-8 mx-auto" defaultActiveKey="0">
