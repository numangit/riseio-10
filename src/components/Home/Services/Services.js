      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
        <div class="col d-flex align-items-start">
          <div class="bg-dark p-3 rounded-3">
            <p className='text-muted display-3 my-4'><FaChalkboardTeacher /></p>
        ...
        <div class="col d-flex align-items-start">
          <div class="bg-dark p-3 rounded-3">
            <p className='text-muted display-3 my-4'><BsFillGiftFill /></p>
        ...
        <div class="col d-flex align-items-start">
          <div class="bg-dark p-3 rounded-3">
            <p className='text-muted display-3 my-4'><BsFillClockFill /></p>
        ...
        <div class="col d-flex align-items-start">
          <div class="bg-dark p-3 rounded-3">
            <p className='text-muted display-3 my-4'><FaUserGraduate /></p>
